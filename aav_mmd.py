...
infeature_ref = "./features/featureFLUX_sub_ref_0/feature_%s_sub_ref_0.txt" % PDB_id_reference
  ...
  for m in range(m_frames):  
    ...
    for i in range(length_prot):
        ...
        for j in range(subsamples):
            ...
            infeature_reference = "./features/featureFLUX_sub_ref_%s/feature_%s_sub_ref_%s.txt" % (m, PDB_id_reference, j)
            ...
            infeature_referenceCTL = "./features/featureFLUX_sub_refCTL_%s/feature_%s_sub_refCTL_%s.txt" % (m, PDB_id_reference, j)
            ...
            infeature_query = "./features/featureFLUX_sub_query_%s/feature_%s_sub_query_%s.txt" % (m, PDB_id_query, j)
        ...
        print("movie frame %s - calculating and bootstrapping MMD for site %s" % (m,i))     
    ...
    if not os.path.exists('maxMeanDiscrepancy_%s/movieFrame_%s' % (PDB_id_reference,m)):
        os.mkdir('maxMeanDiscrepancy_%s/movieFrame_%s' % (PDB_id_reference,m))
    df_out = myMMDindex
    writePath = "./maxMeanDiscrepancy_%s/movieFrame_%s/maxMeanDiscrepancy_flux.txt" % (PDB_id_reference,m)
    ...
    myplot7.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_histo_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot8.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_histo_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot9.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_p_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot10.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_p_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot11.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_res_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot12.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_res_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot13.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_sig_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot14.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_sig_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot15.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_MMD_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    myplot16.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_MMD_flux.png" % (PDB_id_reference,m), width=10, height=5, dpi=300)
    ...
    if(len(n_chains) > 2):
        for x in range(len(n_chains)-1):
            ...
            myplot9.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_p_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot10.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_p_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot11.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_res_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot12.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_res_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot13.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_sig_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot14.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_sig_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot15.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_dark_MMD_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
            myplot16.save("maxMeanDiscrepancy_%s/movieFrame_%s/MMD_light_MMD_flux_%s.png" % (PDB_id_reference,m,myLabel), width=10, height=5, dpi=300)
...
def main():
    ...
    #map_MMD_flux()
    #map_MMDsig_flux()
    print("max mean discrepancy analyses of molecular dynamics is completed")
###############################################################
